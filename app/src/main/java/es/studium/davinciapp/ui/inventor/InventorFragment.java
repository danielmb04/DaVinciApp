...
public class InventorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        InventorViewModel inventorViewModel =
        ...
        inventorViewModel.getTitle().observe(getViewLifecycleOwner(), binding.textInventorTitle::setText);
        inventorViewModel.getDescription().observe(getViewLifecycleOwner(), binding.textInventorDescription::setText);
