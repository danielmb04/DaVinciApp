...
public class PintorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       pintorViewModel.getText().observe(getViewLifecycleOwner(), binding.textPintorTitle::setText);
        pintorViewModel.getDescription().observe(getViewLifecycleOwner(), binding.textPintorDescription::setText);
